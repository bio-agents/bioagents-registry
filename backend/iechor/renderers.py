...
class XMLSchemaRenderer(BaseRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        try:
            ...
            raise ParseError(
                "XML error - %s. Please notify registry-support@iechor-dk.org if you see this error. "
                % e
            )
...
from iechor.bioagents_to_bioschemas import rdfize
...
class JSONLDRenderer(BaseRenderer):
    ...
    def render(self, data, media_type=None, renderer_context=None):
        ...
        data["bioagentsID"] = data["bioagentsID"].lower()
        ...
        # agent = json.loads(json.dumps(data.serializer._data))
