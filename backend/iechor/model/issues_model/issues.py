...
class Issue(models.Model):
    ...
    resource_bioagentsID = models.TextField(blank=True, null=True)
    ...
    @classmethod
    def report(self, bioagentsID):
        return self.objects.filter(resource_bioagentsID=bioagentsID)

    def __unicode__(self):
        return self.resource_bioagentsID + ' \t-\t ' + str(self.issue_type.type) + '\t' + str(self.issue_type.attribute) + '\t' + str(self.issue_type.field_name) + '\t' + str(self.issue_type.field_value) + '\t' + str(self.issue_state.name)
