...
from iechor.model.resource_model.community import Community
...
class Resource(models.Model):
    ...
    #bioagentsID = models.CharField(min_length=1)
    #bioagentsCURIE = models.CharField(min_length=1)
    ...
    #   unless a simple replace of textId with bioagentsID can be done
    bioagentsID = models.CharField(blank=False, null=False, max_length=100)
    bioagentsCURIE = models.CharField(blank=False, null=False, max_length=109) #because of bioagents: prefix
    ...
    iechor_badge = models.IntegerField(choices=IECHOR_BADGE_CHOICES, default=0)
    ...
    iechorInfo = models.ForeignKey(iEchorInfo, null=True, blank=True, on_delete=models.CASCADE)
...
# iechorPlatform
class iEchorPlatform(models.Model):
    iechorPlatform = models.TextField(blank=False, null=True)
    resource = models.ForeignKey(Resource, null=True, blank=True, related_name='iechorPlatform', on_delete=models.CASCADE)
...
# iechorNode
class iEchorNode(models.Model):
    iechorNode = models.TextField(blank=False, null=True)
    resource = models.ForeignKey(Resource, null=True, blank=True, related_name='iechorNode', on_delete=models.CASCADE)
...
# iechorCommunity
class iEchorCommunity(models.Model):
    iechorCommunity = models.TextField(blank=False, null=True)
    resource = models.ForeignKey(Resource, null=True, blank=True, related_name='iechorCommunity', on_delete=models.CASCADE)
