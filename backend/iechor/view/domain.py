...
from iechor.permissions import IsDomainOwnerOrReadOnly, IsOwnerOrReadOnly, HasEditPermissionToEditResourceOrReadOnly, CanConcludeResourceRequest, IsStaffOrReadOnly
...
class DomainResourceView(APIView):
	"""
	Add/remove or list agents for a domain.
	"""
	permission_classes = (IsAuthenticatedOrReadOnly, IsDomainOwnerOrReadOnly, )
