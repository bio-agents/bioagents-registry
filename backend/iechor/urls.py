...
from iechor import views, sitemap
from iechor import edit_permissions
...
urlpatterns = [
	...
	url(r'^t(ool)?/(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/?$', views.ResourceDetail.as_view()),
	url(r'^t(ool)?/(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/validate/?$', views.ResourceUpdateValidator.as_view()),
	# url(r'^t(ool)?/(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/i(ssues)?/(?P<issueId>[a-zA-Z0-9.~_-]+)?$', views.IssueView.as_view()),
	url(r'^t(ool)?/(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/disown/?$', views.DisownResourceView.as_view()),
	...
	url(r'^agent-list/?$', views.AgentList.as_view()),
	url(r'^w/?$', views.WorkflowView.as_view()),
	url(r'^w/(?P<id>[a-zA-Z0-9.~_-]+)/?$', views.WorkflowDetailView.as_view()),
	url(r'^(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/?$', views.ResourceDetail.as_view()),
	url(r'^(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/validate/?$', views.ResourceUpdateValidator.as_view()),
	# url(r'^(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/i(ssues)?/(?P<issueId>[a-zA-Z0-9.~_-]+)?$', views.IssueView.as_view()),
	url(r'^(bioagents\:)?(?P<bioagentsID>[a-zA-Z0-9.~_-]+)/disown/?$', views.DisownResourceView.as_view()),
]
