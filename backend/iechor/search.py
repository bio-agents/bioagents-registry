...
import iechor.search_settings, re
import json
...
def construct_es_query(query_dict):
	...
	search_struct = iechor.search_settings.search_struct
	elastic_query = iechor.search_settings.elastic_query
	...
	if q:
		...
		for term in exact:
			dis_max = {"dis_max": {
				"queries": [
					...
					{ "match_phrase": { "agentType": {"query": term, "boost": 0.5 }}},
		...
		for term in rest:
			dis_max = {"dis_max": {
				"queries": [
					# this should be "bioagentsID" instead of "id"
					{ "match": { "bioagentsID": {"query": term, "boost": 40.0 }}},
					...
					{ "match": { "agentType": {"query": term, "boost": 0.5 }}},
