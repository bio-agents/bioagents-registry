search_struct = {
	'bioagentsID': {
		'attribute': 'bioagentsID',
		'search_field': ['bioagentsID'],
		'exact': True,
	...
	'iechorNode': {
		'attribute': 'iechorNode',
		'search_field': ['iechorNode'],
		'exact': True,
		'simple_query':'default',
		'quoted_query':'phrase'
	},
	'iechorPlatform': {
		'attribute': 'iechorPlatform',
		'search_field': ['iechorPlatform'],
		'exact': True,
		'simple_query':'default',
		'quoted_query':'phrase'
	},
	'iechorCommunity': {
		'attribute': 'iechorCommunity',
		'search_field': ['iechorCommunity'],
		'exact': True,
		'simple_query':'default',
		'quoted_query':'phrase'
	},
