...
from iechor.views import Ontology, User
...
class BaseTestObject(APITestCase):
	...
	def setUp(self):
		...
		es.indices.put_mapping(index=settings.ELASTIC_SEARCH_INDEX, doc_type='agent', body=mapping)
		path_data = '/iechor/application/backend/data'
	...
	def tearDown(self):
		...
		try:
			...
			if TE.status_code == 404:
				...
				raise TE
		settings.ELASTIC_SEARCH_INDEX = 'iechor'
