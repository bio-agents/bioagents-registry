...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		version = ''
		# path_edam_data = '/iechor/application/backend/data/edam'
		...
		operation_tree = {
			...
			'exact_synonyms':[],
			'narrow_synonyms': ['Computational procedure', 'Computational subroutine', 'Computational agent', 'Computational operation', 'Function (programming)', 'Lambda abstraction', 'sumo:Function', 'Mathematical function', 'Process', 'Mathematical operation', 'Function', 'Computational method'],
			'children': []
		}
		...
		data_tree = {
			...
			'definition':"Information, represented in an information artefact (data record) that is 'understandable' by dedicated computational agents that can use the data as input or produce it as output.",
