...
class TestSourceRegistry(BaseTestObject):
    ...
    def test_sourceRegistry_correct(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_correct', format='json')
    ...
    def test_sourceRegistry_empty_zero_length(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_zero_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_sourceRegistry_50_length(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_50_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_sourceRegistry_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_sourceRegistry_array(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_sourceRegistry_dict(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_sourceRegistry_number(self):
        ...
        response = self.client.get(
            '/agent/test_sourceRegistry_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
