...
class TestContactRole(BaseTestObject):
	...
	def test_contactRole_correct_1(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_1', format='json')
	...
	def test_contactRole_correct_2(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_correct_3(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_correct_4(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_4', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_correct_5(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_5', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_correct_6(self):
		...
		response = self.client.get('/agent/test_contactRole_correct_6', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_1_correct_1_wrong(self):
		...
		response = self.client.get('/agent/test_contactRole_1_correct_1_wrong')
	...
	def test_contactRole_empty_none(self):
		...
		response = self.client.get('/agent/test_contactRole_empty_none')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_contactRole_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_non_ascii(self):
		...
		response = self.client.get('/agent/test_contactRole_non_ascii')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_array(self):
		...
		response = self.client.get('/agent/test_contactRole_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_dict(self):
		...
		response = self.client.get('/agent/test_contactRole_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_number(self):
		...
		response = self.client.get('/agent/test_contactRole_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_array_number(self):
		...
		response = self.client.get('/agent/test_contactRole_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactRole_case_sensitive(self):
		...
		response = self.client.get('/agent/test_contactRole_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactRole_duplicate(self):
		...
		response = self.client.get('/agent/test_contactRole_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
