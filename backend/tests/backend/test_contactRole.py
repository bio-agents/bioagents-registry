...
class TestContactRole(BaseTestObject):
    ...
    def test_contactRole_correct_1(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_1', format='json')
    ...
    def test_contactRole_correct_2(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_2', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_correct_3(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_3', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_correct_4(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_4', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_correct_5(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_5', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_correct_6(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_correct_6', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_case_sensitive(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_case_sensitive', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactRole_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_contactRole_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
