...
class TestDocsDownloadSource(BaseTestObject):
	...
	def test_docsDownloadSource_correct(self):
		...
		response = self.client.get('/agent/test_docsDownloadSource_correct', format='json')
	...
	def test_docsDownloadSource_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_docsDownloadSource_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadSource_300_length(self):
		...
		response = self.client.get('/agent/test_docsDownloadSource_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsDownloadSource_non_ascii(self):
		...
		response = self.client.get('/agent/test_docsDownloadSource_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsDownloadSource_case_sensitive(self):
		...
		response = self.client.get('/agent/test_docsDownloadSource_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
