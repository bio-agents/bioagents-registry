...
class TestCreditsAffiliation(BaseTestObject):
	...
	def test_creditsAffiliation_correct_1(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_correct_1', format='json')
	...
	def test_creditsAffiliation_correct_2(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsAffiliation_empty_none(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_empty_none')
	...
	def test_creditsAffiliation_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_300_length(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsAffiliation_301_length(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_non_ascii(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsAffiliation_array(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_dict(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_number(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_array_number(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsAffiliation_duplicate(self):
		...
		response = self.client.get('/agent/test_creditsAffiliation_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
