...
class TestVersion(BaseTestObject):
    ...
    def test_version_correct(self):
        ...
        response = self.client.get(
            '/agent/test_version_correct', format='json')
    ...
    def test_version_empty_zero_length(self):
        ...
        response = self.client.get(
            '/agent/test_version_zero_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_version_50_length(self):
        ...
        response = self.client.get(
            '/agent/test_version_50_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_version_51_length(self):
        ...
        response = self.client.get(
            '/agent/test_version_51_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_version_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_version_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
