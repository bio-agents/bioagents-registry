...
class TestFunctionHandle(BaseTestObject):
    ...
    def test_functionHandle_correct(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_correct', format='json')
    ...
    def test_functionHandle_empty_zero_length(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_empty_zero_length')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_functionHandle_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_functionHandle_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_functionHandle_array(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_functionHandle_dict(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_functionHandle_number(self):
        ...
        response = self.client.get(
            '/agent/test_functionHandle_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
