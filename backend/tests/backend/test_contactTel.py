...
class TestContactTel(BaseTestObject):
    ...
    def test_contactTel_correct(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_correct', format='json')
    ...
    def test_contactTel_30_length(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_30_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactTel_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactTel_array(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactTel_dict(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactTel_number(self):
        ...
        response = self.client.get(
            '/agent/test_contactTel_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
