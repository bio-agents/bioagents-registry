...
class TestContactURL(BaseTestObject):
    ...
    def test_contactURL_correct(self):
        ...
        response = self.client.get(
            '/agent/test_contactURL_correct', format='json')
    ...
    def test_contactURL_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_contactURL_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactURL_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_contactURL_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactURL_case_sensitive(self):
        ...
        response = self.client.get(
            '/agent/test_contactURL_case_sensitive', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
