...
class TestContactURL(BaseTestObject):
	...
	def test_contactURL_correct(self):
		...
		response = self.client.get('/agent/test_contactURL_correct', format='json')
	...
	def test_contactURL_empty_none(self):
		...
		response = self.client.get('/agent/test_contactURL_empty_none')
	...
	def test_contactURL_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_contactURL_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_300_length(self):
		...
		response = self.client.get('/agent/test_contactURL_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactURL_301_length(self):
		...
		response = self.client.get('/agent/test_contactURL_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_non_ascii(self):
		...
		response = self.client.get('/agent/test_contactURL_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactURL_incorrect(self):
		...
		response = self.client.get('/agent/test_contactURL_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_array(self):
		...
		response = self.client.get('/agent/test_contactURL_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_dict(self):
		...
		response = self.client.get('/agent/test_contactURL_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_number(self):
		...
		response = self.client.get('/agent/test_contactURL_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactURL_case_sensitive(self):
		...
		response = self.client.get('/agent/test_contactURL_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
