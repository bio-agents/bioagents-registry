...
class TestPublicationsPrimaryID(BaseTestObject):
	...
	def test_publicationsPrimaryID_correct_1(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_correct_1', format='json')
	...
	def test_publicationsPrimaryID_correct_2(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_publicationsPrimaryID_correct_3(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_publicationsPrimaryID_empty_none(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_empty_none')
	...
	def test_publicationsPrimaryID_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_publicationsPrimaryID_invalid(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_publicationsPrimaryID_array(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_publicationsPrimaryID_dict(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_publicationsPrimaryID_number(self):
		...
		response = self.client.get('/agent/test_publicationsPrimaryID_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
