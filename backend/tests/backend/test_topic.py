...
class TestTopic(BaseTestObject):
    ...
    def test_Topic_Pass_URI_only(self):
        ...
        response = self.client.get(
            '/agent/test_Topic_Pass_URI_only', format='json')
    ...
    def test_Topic_Pass_term_only(self):
        ...
        response = self.client.get(
            '/agent/test_Topic_Pass_term_only', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_Topic_Pass_URI_term(self):
        ...
        response = self.client.get(
            '/agent/test_Topic_Pass_URI_term', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mismatch_correct_Topic_URI_term(self):
        ...
        response = self.client.get(
            '/agent/test_mismatch_correct_Topic_URI_term')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_Topic_Pass_2_topics(self):
        ...
        response = self.client.get(
            '/agent/test_Topic_Pass_2_topics', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_topic_extra_fields(self):
        ...
        response = self.client.get(
            '/agent/test_topic_extra_fields', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
