...
class TestInputDataFormat(BaseTestObject):
	...
	def test_input_dataFormat_Pass_URI_only(self):
		...
		response = self.client.get('/agent/test_input_dataFormat_Pass_URI_only', format='json')
	...
	def test_input_dataFormat_Pass_term_only(self):
		...
		response = self.client.get('/agent/test_input_dataFormat_Pass_term_only', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_input_dataFormat_Pass_URI_term(self):
		...
		response = self.client.get('/agent/test_input_dataFormat_Pass_URI_term', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_Obsolete_input_dataFormat_URI(self):
		...
		response = self.client.get('/agent/test_Obsolete_input_dataFormat_URI')
	...
	def test_Obsolete_input_dataFormat_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_input_dataFormat_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_Obsolete_input_dataFormat_URI_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_input_dataFormat_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_input_dataFormat_URI(self):
		...
		response = self.client.get('/agent/test_incorrect_input_dataFormat_URI')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_input_dataFormat_term(self):
		...
		response = self.client.get('/agent/test_incorrect_input_dataFormat_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_input_dataFormat_URI_term(self):
		...
		response = self.client.get('/agent/test_incorrect_input_dataFormat_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mismatch_correct_inp_dataFormat_URI_term(self):
		...
		response = self.client.get('/agent/test_mismatch_correct_inp_dataFormat_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_string(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_dict(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_number(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_array_number(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_array_array(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_array_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_empty_array(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_empty_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_none(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_none')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dFormat_extra_fields(self):
		...
		response = self.client.get('/agent/test_inp_dFormat_extra_fields', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_inp_dataFormat_duplicate(self):
		...
		response = self.client.get('/agent/test_inp_dataFormat_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
