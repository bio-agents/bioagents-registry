...
class TestLicense(BaseTestObject):
	...
	def test_license_correct_1(self):
		...
		response = self.client.get('/agent/test_license_correct_1', format='json')
	...
	def test_license_correct_2(self):
		...
		response = self.client.get('/agent/test_license_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_3(self):
		...
		response = self.client.get('/agent/test_license_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_4(self):
		...
		response = self.client.get('/agent/test_license_correct_4', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_5(self):
		...
		response = self.client.get('/agent/test_license_correct_5', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_6(self):
		...
		response = self.client.get('/agent/test_license_correct_6', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_7(self):
		...
		response = self.client.get('/agent/test_license_correct_7', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_8(self):
		...
		response = self.client.get('/agent/test_license_correct_8', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_9(self):
		...
		response = self.client.get('/agent/test_license_correct_9', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_10(self):
		...
		response = self.client.get('/agent/test_license_correct_10', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_11(self):
		...
		response = self.client.get('/agent/test_license_correct_11', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_12(self):
		...
		response = self.client.get('/agent/test_license_correct_12', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_13(self):
		...
		response = self.client.get('/agent/test_license_correct_13', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_14(self):
		...
		response = self.client.get('/agent/test_license_correct_14', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_15(self):
		...
		response = self.client.get('/agent/test_license_correct_15', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_16(self):
		...
		response = self.client.get('/agent/test_license_correct_16', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_17(self):
		...
		response = self.client.get('/agent/test_license_correct_17', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_18(self):
		...
		response = self.client.get('/agent/test_license_correct_18', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_19(self):
		...
		response = self.client.get('/agent/test_license_correct_19', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_20(self):
		...
		response = self.client.get('/agent/test_license_correct_20', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_21(self):
		...
		response = self.client.get('/agent/test_license_correct_21', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_22(self):
		...
		response = self.client.get('/agent/test_license_correct_22', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_23(self):
		...
		response = self.client.get('/agent/test_license_correct_23', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_24(self):
		...
		response = self.client.get('/agent/test_license_correct_24', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_25(self):
		...
		response = self.client.get('/agent/test_license_correct_25', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_26(self):
		...
		response = self.client.get('/agent/test_license_correct_26', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_27(self):
		...
		response = self.client.get('/agent/test_license_correct_27', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_28(self):
		...
		response = self.client.get('/agent/test_license_correct_28', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_29(self):
		...
		response = self.client.get('/agent/test_license_correct_29', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_30(self):
		...
		response = self.client.get('/agent/test_license_correct_30', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_31(self):
		...
		response = self.client.get('/agent/test_license_correct_31', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_32(self):
		...
		response = self.client.get('/agent/test_license_correct_32', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_33(self):
		...
		response = self.client.get('/agent/test_license_correct_33', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_34(self):
		...
		response = self.client.get('/agent/test_license_correct_34', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_35(self):
		...
		response = self.client.get('/agent/test_license_correct_35', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_36(self):
		...
		response = self.client.get('/agent/test_license_correct_36', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_37(self):
		...
		response = self.client.get('/agent/test_license_correct_37', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_38(self):
		...
		response = self.client.get('/agent/test_license_correct_38', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_39(self):
		...
		response = self.client.get('/agent/test_license_correct_39', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_40(self):
		...
		response = self.client.get('/agent/test_license_correct_40', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_41(self):
		...
		response = self.client.get('/agent/test_license_correct_41', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_correct_42(self):
		...
		response = self.client.get('/agent/test_license_correct_42', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_license_empty_none(self):
		...
		response = self.client.get('/agent/test_license_empty_none')
	...
	def test_license_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_license_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_license_invalid(self):
		...
		response = self.client.get('/agent/test_license_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_license_array(self):
		...
		response = self.client.get('/agent/test_license_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_license_dict(self):
		...
		response = self.client.get('/agent/test_license_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_license_number(self):
		...
		response = self.client.get('/agent/test_license_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_license_case_sensitive(self):
		...
		response = self.client.get('/agent/test_license_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
