...
class TestUsesVersion(BaseTestObject):
	...
	def test_usesVersion_correct(self):
		...
		response = self.client.get('/agent/test_usesVersion_correct', format='json')
	...
	def test_usesVersion_empty_none(self):
		...
		response = self.client.get('/agent/test_usesVersion_empty_none')
	...
	def test_usesVersion_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_usesVersion_zero_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesVersion_50_length(self):
		...
		response = self.client.get('/agent/test_usesVersion_50_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesVersion_51_length(self):
		...
		response = self.client.get('/agent/test_usesVersion_51_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesVersion_non_ascii(self):
		...
		response = self.client.get('/agent/test_usesVersion_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesVersion_array(self):
		...
		response = self.client.get('/agent/test_usesVersion_array', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesVersion_dict(self):
		...
		response = self.client.get('/agent/test_usesVersion_dict', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesVersion_number(self):
		...
		response = self.client.get('/agent/test_usesVersion_number', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
