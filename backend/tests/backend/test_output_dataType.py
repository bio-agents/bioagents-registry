...
class TestOutputDataType(BaseTestObject):
	...
	def test_output_dataType_Pass_URI_only(self):
		...
		response = self.client.get('/agent/test_output_dataType_Pass_URI_only', format='json')
	...
	def test_output_dataType_Pass_term_only(self):
		...
		response = self.client.get('/agent/test_output_dataType_Pass_term_only', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_output_dataType_Pass_URI_term(self):
		...
		response = self.client.get('/agent/test_output_dataType_Pass_URI_term', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_Obsolete_output_dataType_URI(self):
		...
		response = self.client.get('/agent/test_Obsolete_output_dataType_URI')
	...
	def test_Obsolete_output_dataType_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_output_dataType_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_Obsolete_output_dataType_URI_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_output_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_output_dataType_URI(self):
		...
		response = self.client.get('/agent/test_incorrect_output_dataType_URI')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_output_dataType_term(self):
		...
		response = self.client.get('/agent/test_incorrect_output_dataType_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_output_dataType_URI_term(self):
		...
		response = self.client.get('/agent/test_incorrect_output_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mismatch_correct_out_dataType_URI_term(self):
		...
		response = self.client.get('/agent/test_mismatch_correct_out_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_out_dataType_string(self):
		...
		response = self.client.get('/agent/test_out_dataType_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_out_dataType_array(self):
		...
		response = self.client.get('/agent/test_out_dataType_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_out_dataType_number(self):
		...
		response = self.client.get('/agent/test_out_dataType_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_out_dataType_extra_fields(self):
		...
		response = self.client.get('/agent/test_out_dataType_extra_fields', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
