...
class TestContactName(BaseTestObject):
    ...
    def test_contactName_correct(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_correct', format='json')
    ...
    def test_contactName_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactName_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactName_array(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactName_dict(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_contactName_number(self):
        ...
        response = self.client.get(
            '/agent/test_contactName_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
