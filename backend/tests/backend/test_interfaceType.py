...
class TestInterfaceType(BaseTestObject):
	...
	def test_interfaceType_correct_1(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_1', format='json')
	...
	def test_interfaceType_correct_2(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_correct_3(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_correct_4(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_4', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_correct_5(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_5', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_correct_6(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_6', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_correct_7(self):
		...
		response = self.client.get('/agent/test_interfaceType_correct_7', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceType_empty_none(self):
		...
		response = self.client.get('/agent/test_interfaceType_empty_none')
	...
	def test_interfaceType_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_interfaceType_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceType_array(self):
		...
		response = self.client.get('/agent/test_interfaceType_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceType_string(self):
		...
		response = self.client.get('/agent/test_interfaceType_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceType_dict(self):
		...
		response = self.client.get('/agent/test_interfaceType_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceType_number(self):
		...
		response = self.client.get('/agent/test_interfaceType_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceType_case_sensitive(self):
		...
		response = self.client.get('/agent/test_interfaceType_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
