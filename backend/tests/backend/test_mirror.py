...
class TestMirror(BaseTestObject):
	...
	def test_mirror_correct_1(self):
		...
		response = self.client.get('/agent/test_mirror_correct_1', format='json')
	...
	def test_mirror_correct_2(self):
		...
		response = self.client.get('/agent/test_mirror_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_mirror_empty_none(self):
		...
		response = self.client.get('/agent/test_mirror_empty_none')
	...
	def test_mirror_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_mirror_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_invalid(self):
		...
		response = self.client.get('/agent/test_mirror_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_string(self):
		...
		response = self.client.get('/agent/test_mirror_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_array(self):
		...
		response = self.client.get('/agent/test_mirror_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_dict(self):
		...
		response = self.client.get('/agent/test_mirror_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_number(self):
		...
		response = self.client.get('/agent/test_mirror_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_case_sensitive(self):
		...
		response = self.client.get('/agent/test_mirror_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_mirror_300_length(self):
		...
		response = self.client.get('/agent/test_mirror_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_mirror_301_length(self):
		...
		response = self.client.get('/agent/test_mirror_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mirror_non_ascii(self):
		...
		response = self.client.get('/agent/test_mirror_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_mirror_duplicate(self):
		...
		response = self.client.get('/agent/test_mirror_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
