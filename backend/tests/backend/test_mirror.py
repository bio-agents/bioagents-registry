...
class TestMirror(BaseTestObject):
    ...
    def test_mirror_correct_1(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_correct_1', format='json')
    ...
    def test_mirror_correct_2(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_correct_2', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        expected_resource = emptyOutputAgent()

        expected_resource['id'] = 'test_mirror_correct_2'
        expected_resource['mirror'] = [
    ...
    def test_mirror_case_sensitive(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_case_sensitive', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mirror_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mirror_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mirror_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_mirror_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
