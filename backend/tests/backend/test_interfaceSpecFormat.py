...
class TestInterfaceSpecFormat(BaseTestObject):
	...
	def test_interfaceSpecFormat_correct_1(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_correct_1', format='json')
	...
	def test_interfaceSpecFormat_correct_2(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_interfaceSpecFormat_empty_none(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_empty_none')
	...
	def test_interfaceSpecFormat_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_non_ascii(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_non_ascii')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_incorrect(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_array(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_dict(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_number(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_interfaceSpecFormat_case_sensitive(self):
		...
		response = self.client.get('/agent/test_interfaceSpecFormat_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
