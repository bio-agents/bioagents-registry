...
class TestCollection(BaseTestObject):
	...
	def test_collection_correct_1(self):
		...
		response = self.client.get('/agent/test_collection_correct_1', format='json')
	...
	def test_collection_correct_2(self):
		...
		response = self.client.get('/agent/test_collection_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_collection_empty_none(self):
		...
		response = self.client.get('/agent/test_collection_empty_none')
	...
	def test_collection_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_collection_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_300_length(self):
		...
		response = self.client.get('/agent/test_collection_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_collection_301_length(self):
		...
		response = self.client.get('/agent/test_collection_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_non_ascii(self):
		...
		response = self.client.get('/agent/test_collection_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_collection_array(self):
		...
		response = self.client.get('/agent/test_collection_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_dict(self):
		...
		response = self.client.get('/agent/test_collection_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_number(self):
		...
		response = self.client.get('/agent/test_collection_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_array_number(self):
		...
		response = self.client.get('/agent/test_collection_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_collection_duplicate(self):
		...
		response = self.client.get('/agent/test_collection_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
