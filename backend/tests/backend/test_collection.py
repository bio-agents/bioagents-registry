...
class TestCollection(BaseTestObject):
    ...
    def test_collection_correct_1(self):
        ...
        response = self.client.get(
            '/agent/test_collection_correct_1', format='json')
    ...
    def test_collection_correct_2(self):
        ...
        sent_resource['collection'] = [
            'Just a collection', 'another collection']

        response = self.client.post('/agent/', sent_resource, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)

        response = self.client.get(
            '/agent/test_collection_correct_2', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_collection_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_collection_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_collection_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_collection_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_collection_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_collection_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
