...
class TestResourceType(BaseTestObject):
	...
	def test_resourceType_correct_1(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_1', format='json')
	...
	def test_resourceType_correct_2(self):
		...
		sent_resource['resourceType'] = ['Agent']
		
		response = self.client.post('/agent/', sent_resource, format='json')
		self.assertEqual(response.status_code, status.HTTP_201_CREATED)

		response = self.client.get('/agent/test_resourceType_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputAgent()

		expected_resource['id'] = 'test_resourceType_correct_2'
		expected_resource['resourceType'] = ['Agent']
	...
	def test_resourceType_correct_3(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_correct_4(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_4', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_correct_5(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_5', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_correct_6(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_6', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_correct_7(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_7', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_correct_8(self):
		...
		response = self.client.get('/agent/test_resourceType_correct_8', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_2_correct(self):
		...
		sent_resource['resourceType'] = ['Agent', 'Other']
		
		response = self.client.post('/agent/', sent_resource, format='json')
		self.assertEqual(response.status_code, status.HTTP_201_CREATED)

		response = self.client.get('/agent/test_resourceType_2_correct', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputAgent()

		expected_resource['id'] = 'test_resourceType_2_correct'
		expected_resource['resourceType'] = ['Agent', 'Other']
	...
	def test_resourceType_1_correct_1_not(self):
		...
		sent_resource['resourceType'] = ['Agent', 'random string here']
		...
		response = self.client.get('/agent/test_resourceType_1_correct_1_not')
	...
	def test_resourceType_empty_none(self):
		...
		response = self.client.get('/agent/test_resourceType_empty_none')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_resourceType_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_invalid(self):
		...
		response = self.client.get('/agent/test_resourceType_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_string(self):
		...
		response = self.client.get('/agent/test_resourceType_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_array(self):
		...
		response = self.client.get('/agent/test_resourceType_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_dict(self):
		...
		response = self.client.get('/agent/test_resourceType_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_number(self):
		...
		response = self.client.get('/agent/test_resourceType_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_resourceType_case_sensitive(self):
		...
		Purpose:
			What happens when we send correct value but with incorrect case (agent instead of Agent)
		Sent:
			Value with correct string but lowercase (agent instead of Agent)
		Expected outcome:
		...
		response = self.client.get('/agent/test_resourceType_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_resourceType_duplicate(self):
		...
		response = self.client.get('/agent/test_resourceType_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
