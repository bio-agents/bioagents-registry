...
class TestiEchorNode(BaseTestObject):
	...
	def test_iechorNode_correct_1(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_1', format='json')
	...
	def test_iechorNode_correct_2(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_3(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_4(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_4', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_5(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_5', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_6(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_6', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_7(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_7', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_8(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_8', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_9(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_9', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_10(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_10', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_11(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_11', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_12(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_12', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_13(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_13', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_14(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_14', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_15(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_15', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_16(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_16', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_17(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_17', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_correct_18(self):
		...
		response = self.client.get('/agent/test_iechorNode_correct_18', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_iechorNode_case_sensitive(self):
		...
		response = self.client.get('/agent/test_iechorNode_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
