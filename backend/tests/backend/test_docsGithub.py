...
class TestDocsDownloadGithub(BaseTestObject):
	...
	def test_docsGithub_correct(self):
		...
		response = self.client.get('/agent/test_docsGithub_correct', format='json')
	...
	def test_docsGithub_empty_none(self):
		...
		response = self.client.get('/agent/test_docsGithub_empty_none')
	...
	def test_docsGithub_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_docsGithub_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_300_length(self):
		...
		response = self.client.get('/agent/test_docsGithub_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsGithub_301_length(self):
		...
		response = self.client.get('/agent/test_docsGithub_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_non_ascii(self):
		...
		response = self.client.get('/agent/test_docsGithub_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsGithub_incorrect(self):
		...
		response = self.client.get('/agent/test_docsGithub_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_array(self):
		...
		response = self.client.get('/agent/test_docsGithub_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_dict(self):
		...
		response = self.client.get('/agent/test_docsGithub_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_number(self):
		...
		response = self.client.get('/agent/test_docsGithub_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsGithub_case_sensitive(self):
		...
		response = self.client.get('/agent/test_docsGithub_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
