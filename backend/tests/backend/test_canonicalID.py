...
class TestCanonicalID(BaseTestObject):
    ...
    def test_canonicalID_correct(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_correct', format='json')
    ...
    def test_canonicalID_empty_zero_length(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_empty_zero_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_canonicalID_50_length(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_50_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_canonicalID_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_canonicalID_array(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_canonicalID_dict(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_canonicalID_number(self):
        ...
        response = self.client.get(
            '/agent/test_canonicalID_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
