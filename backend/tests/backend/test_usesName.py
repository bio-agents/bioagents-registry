...
class TestUsesName(BaseTestObject):
	...
	def test_usesName_correct(self):
		...
		response = self.client.get('/agent/test_usesName_correct', format='json')
	...
	def test_usesName_empty_none(self):
		...
		response = self.client.get('/agent/test_usesName_empty_none')
	...
	def test_usesName_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_usesName_zero_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesName_50_length(self):
		...
		response = self.client.get('/agent/test_usesName_50_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesName_301_length(self):
		...
		response = self.client.get('/agent/test_usesName_301_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesName_non_ascii(self):
		...
		response = self.client.get('/agent/test_usesName_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesName_array(self):
		...
		response = self.client.get('/agent/test_usesName_array', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesName_dict(self):
		...
		response = self.client.get('/agent/test_usesName_dict', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesName_number(self):
		...
		response = self.client.get('/agent/test_usesName_number', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
