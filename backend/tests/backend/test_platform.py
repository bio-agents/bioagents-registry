...
class TestPlatform(BaseTestObject):
	...
	def test_platform_correct_1(self):
		...
		response = self.client.get('/agent/test_platform_correct_1', format='json')
	...
	def test_platform_correct_2(self):
		...
		response = self.client.get('/agent/test_platform_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_platform_correct_3(self):
		...
		response = self.client.get('/agent/test_platform_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_platform_empty_none(self):
		...
		response = self.client.get('/agent/test_platform_empty_none')
	...
	def test_platform_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_platform_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_invalid(self):
		...
		response = self.client.get('/agent/test_platform_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_string(self):
		...
		response = self.client.get('/agent/test_platform_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_array(self):
		...
		response = self.client.get('/agent/test_platform_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_dict(self):
		...
		response = self.client.get('/agent/test_platform_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_number(self):
		...
		response = self.client.get('/agent/test_platform_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_platform_case_sensitive(self):
		...
		response = self.client.get('/agent/test_platform_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_platform_duplicate(self):
		...
		response = self.client.get('/agent/test_platform_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
