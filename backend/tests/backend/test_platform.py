...
class TestPlatform(BaseTestObject):
    ...
    def test_platform_correct_1(self):
        ...
        response = self.client.get(
            '/agent/test_platform_correct_1', format='json')
    ...
    def test_platform_correct_2(self):
        ...
        response = self.client.get(
            '/agent/test_platform_correct_2', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_platform_correct_3(self):
        ...
        response = self.client.get(
            '/agent/test_platform_correct_3', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_platform_case_sensitive(self):
        ...
        response = self.client.get(
            '/agent/test_platform_case_sensitive', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_platform_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_platform_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
