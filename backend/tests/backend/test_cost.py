...
class TestCost(BaseTestObject):
	...
	def test_cost_correct_1(self):
		...
		response = self.client.get('/agent/test_cost_correct_1', format='json')
	...
	def test_cost_correct_2(self):
		...
		response = self.client.get('/agent/test_cost_correct_2', format='json')
	...
	def test_cost_correct_3(self):
		...
		response = self.client.get('/agent/test_cost_correct_3', format='json')
	...
	def test_cost_empty_none(self):
		...
		response = self.client.get('/agent/test_cost_empty_none')
	...
	def test_cost_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_cost_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_cost_invalid(self):
		...
		response = self.client.get('/agent/test_cost_invalid', format='json')
		...
		response = self.client.get('/agent/test_cost_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_cost_array(self):
		...
		response = self.client.get('/agent/test_cost_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_cost_dict(self):
		...
		response = self.client.get('/agent/test_cost_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_cost_number(self):
		...
		response = self.client.get('/agent/test_cost_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_cost_case_insensitive(self):
		...
		response = self.client.get('/agent/test_cost_case_insensitive', format='json')
