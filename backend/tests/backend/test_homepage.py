...
class TestHomepage(BaseTestObject):
	...
	def test_homepage_correct(self):
		...
		response = self.client.get('/agent/test_homepage_correct', format='json')
	...
	def test_homepage_empty_none(self):
		...
		response = self.client.get('/agent/test_homepage_empty_none')
	...
	def test_homepage_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_homepage_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_300_length(self):
		...
		response = self.client.get('/agent/test_homepage_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_homepage_301_length(self):
		...
		response = self.client.get('/agent/test_homepage_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_non_ascii(self):
		...
		response = self.client.get('/agent/test_homepage_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_homepage_incorrect(self):
		...
		response = self.client.get('/agent/test_homepage_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_array(self):
		...
		response = self.client.get('/agent/test_homepage_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_dict(self):
		...
		response = self.client.get('/agent/test_homepage_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_number(self):
		...
		response = self.client.get('/agent/test_homepage_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_homepage_case_sensitive(self):
		...
		response = self.client.get('/agent/test_homepage_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
