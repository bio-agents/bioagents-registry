...
class TestCreditsFunding(BaseTestObject):
    ...
    def test_creditsFunding_correct_1(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_correct_1', format='json')
    ...
    def test_creditsFunding_correct_2(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_correct_2', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_creditsFunding_empty_zero_length(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_empty_zero_length')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_creditsFunding_300_length(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_300_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_creditsFunding_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_creditsFunding_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_creditsFunding_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
