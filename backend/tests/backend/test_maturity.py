...
class TestMaturity(BaseTestObject):
	...
	def test_maturity_correct_1(self):
		...
		response = self.client.get('/agent/test_maturity_correct_1', format='json')
	...
	def test_maturity_correct_2(self):
		...
		response = self.client.get('/agent/test_maturity_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_maturity_correct_3(self):
		...
		response = self.client.get('/agent/test_maturity_correct_3', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_maturity_empty_none(self):
		...
		response = self.client.get('/agent/test_maturity_empty_none')
	...
	def test_maturity_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_maturity_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_maturity_invalid(self):
		...
		response = self.client.get('/agent/test_maturity_invalid')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_maturity_array(self):
		...
		response = self.client.get('/agent/test_maturity_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_maturity_dict(self):
		...
		response = self.client.get('/agent/test_maturity_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_maturity_number(self):
		...
		response = self.client.get('/agent/test_maturity_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_maturity_case_sensitive(self):
		...
		response = self.client.get('/agent/test_maturity_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
