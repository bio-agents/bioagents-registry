...
class TestDescription(BaseTestObject):
    ...
    def test_description_correct(self):
        ...
        response = self.client.get(
            '/agent/test_description_correct', format='json')
    ...
    def test_description_1000_length(self):
        ...
        response = self.client.get(
            '/agent/test_description_1000_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_description_non_ascii(self):
        ...
        response = self.client.get(
            '/agent/test_description_non_ascii', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_description_array(self):
        ...
        response = self.client.get(
            '/agent/test_description_array', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_description_dict(self):
        ...
        response = self.client.get(
            '/agent/test_description_dict', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_description_number(self):
        ...
        response = self.client.get(
            '/agent/test_description_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
