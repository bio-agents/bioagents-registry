...
class TestFunctionName(BaseTestObject):
    ...
    def test_operation_Pass_URI_only(self):
        ...
        response = self.client.get(
            '/agent/test_operation_Pass_URI_only', format='json')
    ...
    def test_operation_Pass_term_only(self):
        ...
        response = self.client.get(
            '/agent/test_operation_Pass_term_only', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_operation_Pass_URI_term(self):
        ...
        response = self.client.get(
            '/agent/test_operation_Pass_URI_term', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mismatch_correct_fName_URI_term(self):
        ...
        response = self.client.get(
            '/agent/test_mismatch_correct_fName_URI_term')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_operation_Pass_2_operations(self):
        ...
        response = self.client.get(
            '/agent/test_operation_Pass_2_operations', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_operation_extra_fields(self):
        ...
        response = self.client.get(
            '/agent/test_operation_extra_fields', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_operation_duplicate(self):
        ...
        response = self.client.get(
            '/agent/test_operation_duplicate', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
