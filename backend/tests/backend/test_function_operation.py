...
class TestFunctionName(BaseTestObject):
	...
	def test_operation_Pass_URI_only(self):
		...
		response = self.client.get('/agent/test_operation_Pass_URI_only', format='json')
	...
	def test_operation_Pass_term_only(self):
		...
		response = self.client.get('/agent/test_operation_Pass_term_only', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_operation_Pass_URI_term(self):
		...
		response = self.client.get('/agent/test_operation_Pass_URI_term', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_Obsolete_operation_URI(self):
		...
		response = self.client.get('/agent/test_Obsolete_operation_URI')
	...
	def test_Obsolete_operation_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_operation_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_Obsolete_operation_URI_term(self):
		...
		response = self.client.get('/agent/test_Obsolete_operation_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_operation_URI(self):
		...
		response = self.client.get('/agent/test_incorrect_operation_URI')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_operation_term(self):
		...
		response = self.client.get('/agent/test_incorrect_operation_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_operation_URI_term(self):
		...
		response = self.client.get('/agent/test_incorrect_operation_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mismatch_correct_fName_URI_term(self):
		...
		response = self.client.get('/agent/test_mismatch_correct_fName_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_Pass_2_operations(self):
		...
		response = self.client.get('/agent/test_operation_Pass_2_operations', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_operation_2_fNames_incorrect(self):
		...
		response = self.client.get('/agent/test_operation_2_fNames_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_string(self):
		...
		response = self.client.get('/agent/test_operation_string')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_dict(self):
		...
		response = self.client.get('/agent/test_operation_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_number(self):
		...
		response = self.client.get('/agent/test_operation_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_array_number(self):
		...
		response = self.client.get('/agent/test_operation_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_array_array(self):
		...
		response = self.client.get('/agent/test_operation_array_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_extra_fields(self):
		...
		response = self.client.get('/agent/test_operation_extra_fields', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_operation_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_operation_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_operation_duplicate(self):
		...
		response = self.client.get('/agent/test_operation_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
