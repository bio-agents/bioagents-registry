...
class TestName(BaseTestObject):
    ...
    def test_name_correct(self):
        ...
        response = self.client.get('/agent/test_name_correct', format='json')
    ...
    def test_name_empty_none(self):
        ...
        response = self.client.get('/agent/test_name_empty_none')
    ...
    def test_name_empty_zero_length(self):
        ...
        response = self.client.get('/agent/test_name_empty_zero_length')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_name_50_length(self):
        ...
        response = self.client.get('/agent/test_name_50_length', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_name_51_length(self):
        ...
        response = self.client.get('/agent/test_name_51_length')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_name_non_ascii(self):
        ...
        response = self.client.get('/agent/test_name_non_ascii')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_name_array(self):
        ...
        response = self.client.get('/agent/test_name_dict')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(json.loads(response.content), expected_response)
    ...
    def test_name_number(self):
        ...
        response = self.client.get('/agent/test_name_number', format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
