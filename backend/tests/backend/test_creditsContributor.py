...
class TestCreditsContributor(BaseTestObject):
	...
	def test_creditsContributor_correct_1(self):
		...
		response = self.client.get('/agent/test_creditsContributor_correct_1', format='json')
	...
	def test_creditsContributor_correct_2(self):
		...
		response = self.client.get('/agent/test_creditsContributor_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsContributor_empty_none(self):
		...
		response = self.client.get('/agent/test_creditsContributor_empty_none')
	...
	def test_creditsContributor_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_creditsContributor_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_300_length(self):
		...
		response = self.client.get('/agent/test_creditsContributor_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsContributor_301_length(self):
		...
		response = self.client.get('/agent/test_creditsContributor_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_non_ascii(self):
		...
		response = self.client.get('/agent/test_creditsContributor_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsContributor_array(self):
		...
		response = self.client.get('/agent/test_creditsContributor_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_dict(self):
		...
		response = self.client.get('/agent/test_creditsContributor_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_number(self):
		...
		response = self.client.get('/agent/test_creditsContributor_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_array_number(self):
		...
		response = self.client.get('/agent/test_creditsContributor_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsContributor_duplicate(self):
		...
		response = self.client.get('/agent/test_creditsContributor_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
