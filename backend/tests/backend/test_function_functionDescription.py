...
class TestFunctionDescription(BaseTestObject):
	...
	def test_functionDescription_correct(self):
		...
		response = self.client.get('/agent/test_functionDescription_correct', format='json')
	...
	def test_functionDescription_empty_none(self):
		...
		response = self.client.get('/agent/test_functionDescription_empty_none')
	...
	def test_functionDescription_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_functionDescription_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_functionDescription_1000_length(self):	
		...
		response = self.client.get('/agent/test_functionDescription_1000_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_functionDescription_1001_length(self):
		...
		response = self.client.get('/agent/test_functionDescription_1001_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_functionDescription_non_ascii(self):
		...
		response = self.client.get('/agent/test_functionDescription_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_functionDescription_array(self):
		...
		response = self.client.get('/agent/test_functionDescription_array', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_functionDescription_dict(self):
		...
		response = self.client.get('/agent/test_functionDescription_dict', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_functionDescription_number(self):
		...
		response = self.client.get('/agent/test_functionDescription_number', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
