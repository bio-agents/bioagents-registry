...
class TestContactEmail(BaseTestObject):
	...
	def test_contactEmail_correct(self):
		...
		response = self.client.get('/agent/test_contactEmail_correct', format='json')
	...
	def test_contactEmail_empty_none(self):
		...
		response = self.client.get('/agent/test_contactEmail_empty_none')
	...
	def test_contactEmail_empty_zero_length(self):
		...
		response = self.client.get('/agent/test_contactEmail_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_300_length(self):
		...
		response = self.client.get('/agent/test_contactEmail_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_contactEmail_301_length(self):
		...
		response = self.client.get('/agent/test_contactEmail_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_non_ascii(self):
		...
		response = self.client.get('/agent/test_contactEmail_non_ascii')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_incorrect(self):
		...
		response = self.client.get('/agent/test_contactEmail_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_array(self):
		...
		response = self.client.get('/agent/test_contactEmail_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_dict(self):
		...
		response = self.client.get('/agent/test_contactEmail_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_contactEmail_number(self):
		...
		response = self.client.get('/agent/test_contactEmail_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
