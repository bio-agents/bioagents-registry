"""
Django settings for iechorapp project.
...
WSGI_APPLICATION = getenv('WSGI_APPLICATION', 'iechorapp.wsgi.application')
...
STATIC_ROOT = getenv('STATIC_ROOT', '/iechor/application/frontend/static/')
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'iechor.serializers.UserSerializer',
    'PASSWORD_RESET_SERIALIZER': 'iechor.serializers.CustomPasswordResetSerializer'
}
# necessary for custom user validation
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'iechor.serializers.UserRegisterSerializer'
}

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
ACCOUNT_ADAPTER = 'iechor.adapters.CustomDefaultAccountAdapter'
