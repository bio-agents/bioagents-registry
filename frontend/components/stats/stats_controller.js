...
angular.module('iechor_front.controllers').controller('StatsController', ['$scope', '$http', 'StatsDataSource', function($scope, $http, StatsDataSource) {
	// Initialization
	var _this = this;
	$scope.labels = [];
	$scope.labelsUsers = [];
	...
	$scope.seriesTotalAnnotationDetail = ['Name', 'Description', 'Homepage', 'Agent Type', 'Unique Id', 'Topic', 'Publication', 'Contact', 'Operation', 'Documentation', 'Operating System', 'Input output', 'Code availability', 'Accessibility', 'Data format', 'Community', 'Downloads', 'Total'];
	...
	this.initializeTotalAnnotationsDetailStatsGraph = function() {
		...
		_.map(annotationData, function(x) {
			return x.agentTypeAnnotationCount;
		}),
		_.map(annotationData, function(x) {
