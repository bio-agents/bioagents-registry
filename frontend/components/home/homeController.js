...
.controller('HomeController', ['$scope','$state', '$stateParams', function($scope, $state, $stateParams) {
	...
	angular.module('iechor_front')
.directive('homeSearch', ['Query', 'AgentList', 'Highlighting', 'Attribute', '$state', '$stateParams', '$timeout', 'UsedTerms', '$q', 'filterFilter', 'Domain', '$rootScope', '$location', '$anchorScroll', function(Query, AgentList, Highlighting, Attribute, $state, $stateParams, $timeout, UsedTerms, $q, filterFilter, Domain, $rootScope, $location, $anchorScroll) {
	return {
		restrict: 'A',
