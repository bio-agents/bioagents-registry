// Controllers
angular.module('iechor_front.controllers').controller('RequestsController', ['$scope', 'ResourceRequestProvider', 'User', function($scope, ResourceRequestProvider, User) {
	var vm = this;
	$scope.requests = {};
	$scope.received = [];
	$scope.sent = [];
...
iechor_front.factory('ResourceRequestProvider', ['$http', function ($http) {
	return {
