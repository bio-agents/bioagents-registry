// Controllers
angular.module('iechor_front.controllers').controller('PermissionsController', ['$scope', 'UserSuggestionsProvider', function($scope, UserSuggestionsProvider) {
	var vm = this;
...
iechor_front.factory('UserSuggestionsProvider', ['$http', function ($http) {
	return {
