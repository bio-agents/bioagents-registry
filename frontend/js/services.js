...
.service('Attribute', function() {
	this.description = {
		...
		version: {
			description: "Agent version information. Use 'Add version' to enter individual version numbers (if practical).",
			label: "Current version"
		},
		description: {
			description: "Agent description, e.g. a few sentences adapted from the agent publication abstract or homepage.",
			label: "Description"
		},
		operation: {
			description: "A basic operation performed by this agent function.",
			label: "Operation"
		},
		functionNote: {
		...
		homepage: {
			description: "Homepage of the agent, or some URL that best serves this purpose.",
			label: "Homepage URL"
		},
		contact: {
		...
		sourceRegistry: {
			description: "Link to the registry (or other collection) from which the agent was imported (URL)",
		...
		cost: {
			description: "Monetary cost of acquiring the agent.",
			label: "Cost"
		},
		iechorInfo: {
		...
		language: {
			description: "Name of a programming language, e.g. used for the agent source code.",
			label: "Language"
		},
		license: {
		...
		linkURL: {
			description: "A link of some relevance to the agent (URL).",
			label: "linkURL"
		},
		linkType: {
		...
		downloadURL: {
			description: "Link to download (or repository providing a download) for the agent.",
			label: "downloadURL"
		},
		downloadType: {
		...
		publicationPMCID: {
			description: "PubMed Central Identifier (PMCID) of a publication about the agent.",
			label: "publicationPMCID"
		},
		publicationPMID: {
			description: "PubMed Identifier (PMID) of a publication about the agent.",
			label: "publicationPMID"
		},
		publicationDOI: {
			description: "Digital Object Identifier (DOI) of a publication about the agent.",
		...
		iechorCommunity: {
			description: "Name of the community participating in IECHOR",
		...
		relationType: {
			description: 'Type of relation between this and another registered agent, e.g. "isNewVersionOf"',
			label: "relationType"
		},
		confidence: {
